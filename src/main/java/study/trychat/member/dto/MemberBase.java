...
public sealed interface MemberBase permits MemberProfileResponse, MemberProfileUpdateRequest, MemberRemoveRequest, MemberResponse, MemberUpdateRequest {
  ...
  record MemberRemoveRequest(
          ...
          @Pattern(message = "비밀번호 양식을 지켜주세요.", regexp = "^(?=.*[A-Z])(?=.*[!@#$%^&*])(?=.*[0-9]).{8,64}$")
