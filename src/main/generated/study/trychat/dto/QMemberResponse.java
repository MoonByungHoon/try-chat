...
public class QMemberResponse extends ConstructorExpression<MemberResponse> {
    ...
    public QMemberResponse(com.querydsl.core.types.Expression<Long> id, com.querydsl.core.types.Expression<String> nickname, com.querydsl.core.types.Expression<String> greetings, com.querydsl.core.types.Expression<String> profileImg, com.querydsl.core.types.Expression<String> profileImgPath) {
