...
/**
 * study.trychat.dto.QMemberRequest is a Querydsl Projection type for MemberRequestt
 */
@Generated("com.querydsl.codegen.DefaultProjectionSerializer")
public class QMemberRequest extends ConstructorExpression<MemberRequestt> {
    ...
    public QMemberRequest(com.querydsl.core.types.Expression<Long> id, com.querydsl.core.types.Expression<String> nickname, com.querydsl.core.types.Expression<String> greetings, com.querydsl.core.types.Expression<String> profileImg, com.querydsl.core.types.Expression<String> profileImgPath) {
        super(MemberRequestt.class, new Class<?>[]{long.class, String.class, String.class, String.class, String.class}, id, nickname, greetings, profileImg, profileImgPath);
    }
